...
" Command definition
"----------------------------------------------------------------------
command! -nargs=1 VimTweakSetAlphaPy         call s:SetAlpha(0 + <args>)
command!          VimTweakEnableMaxPy        call s:EnableMaximize(1)
command!          VimTweakDisableMaxPy       call s:EnableMaximize(0)
command!          VimTweakEnableAlwaysTopPy  call s:EnableTopMost(1)
command!          VimTweakDisableAlwaysTopPy call s:EnableTopMost(0)
command!          VimTweakEnableCaptionPy    call s:EnableCaption(1)
command!          VimTweakDisableCaptionPy   call s:EnableCaption(0)
